...
const DownloadAndResetButtons = ({ image, setImage }) => {
  ...
  const generateAndDownloadImage = () => {
    if (imageType === "jpeg") {
      domtoimage.toJpeg(document.getElementById("snapshot-node"))
        .then((dataUrl) => {
      ...
      domtoimage.toPng(document.getElementById("snapshot-node"))
        .then((dataUrl) => {
          let link = document.createElement("a");
      ...
      domtoimage.toSvg(document.getElementById("snapshot-node"))
        .then((dataUrl) => {
          let link = document.createElement("a");
